...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    public final org.choongang.member.entites.QMember member;
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new org.choongang.member.entites.QMember(forProperty("member")) : null;
    }
