...
public class Ex03 {
    ...
    @BeforeAll // 모든 테스트메서드 실행전 한번만 실행
    static void init(){
    ...
    void test2(){
        ...
        /*커넥션 풀 설정 S*/
        ds.setInitialSize(2); //로드 초기에 생성할 연결 객체수 (기본값 10)
        ds.setMaxActive(10); //최대 생성할 연결 객체 수 설정 (기본값 최대 100개)
        ds.setTestWhileIdle(true); //연결 객체가 유휴 상태일때 연결 상태 체크
