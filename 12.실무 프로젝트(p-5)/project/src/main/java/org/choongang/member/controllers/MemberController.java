...
@Tag(name = "Member", description = "회원 API") // api 명세 그룹화
@RestController
@RequestMapping("/api/v1/member")
public class MemberController {

    @PostMapping
    @Operation(summary = "회원가입",description = "회원가입에 대한 자세한 설명") //요청 데이터 명세 상세하기 보기
    @ApiResponse(responseCode = "201", description = "회원가입 성공시 201") //응답 데이터에 대한 설명
    @Parameters(
            {
