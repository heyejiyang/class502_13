...
public class JoinServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setCharacterEncoding("UTF-8"); //서블릿 4버전까지, 기본 유니코드 2바이트 형식, 서블릿 6 버전 부터는 기본 유니코드가 3바이트(UTF-8)

        String email = req.getParameter("email"); //getParameter로 조회
       ...
       // String hobby = req.getParameter("hobby");
        ...
        System.out.printf("email = %s, password = %s, confrimPw = %s, userNm=%s\n", email, password,confrimPassword,userName);
